...
@section('content')
@if (isset($record))
<form method="POST" action="{{route('admin.ward.update',$record->id)}}">
    @method('PUT')
@else
<form method="POST" action="{{route('admin.ward.store')}}">
@endif
    @csrf
    <div class="content">
				...
				<div class="card">
					<div class="card-body">
                        <div class="form-group">
                            <label class="font-weight-semibold">Tên phường,xã <span class="required"></span></label>
