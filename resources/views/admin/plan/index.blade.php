...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn mb-2 btn-success" href="{{route('admin.plan.create')}}"><i class="icon-plus-circle2"></i> Thêm mới</a>
            @if(count($records))
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('admin.plan.edit', $record->id)}}">{{$record->name}}</a>
                            </td>
...
<script>
    ...
    $('.js-delete').on('click', function() {
        ...
        swal({
            ...
            if (res.value) {
                $.ajax({
                    url: '{{route('admin.plan.destroy','idx')}}'.replace(/idx/, id),
