     <!-- Main Header -->
     <header id="header" class="main-header @if(Route::is('index') )home3 header header-fixed style-absolute @endif">
                <!-- Header Lower -->
                            ...
                            <div class="col-lg-12">         
                                <div class="inner-container flex justify-space align-center">
                                    ...
                                    <div class="logo-box flex">
                                        <div class="logo"><a href="{{route('index')}}"><img src="{{$shared_config['logo']['value']}}" alt="" width="197" height="48"></a></div>
                                    </div>
                                    ...
                                    <div class="header-account flex align-center">
                                        <div class="register">
                                            <ul class="flex align-center">
                                                ...
                                                <li><span>/</span></li> -->
                                                @if(Auth::guest())
                                                <li class=""><a href="#" data-toggle="modal" data-target="#popup_bid"> Đăng nhập</a></li>
                                                @else
                                                Chào, {{Auth::user()->name}}
                                                @endif
                                            </ul>
                ...
                <div class="mobile-menu">
                    ...
                    <nav class="menu-box">
                        <div class="nav-logo"><a href="index.html"><img src="{{asset('phiatay/assets/images/logo/logo%402x.png')}}" alt="" width="197" height="48"></a></div>
                        <div class="bottom-canvas">
                            <div class="login-box flex align-center">
                                ...
                                @if(Auth::guest())
                                <a href="#" data-toggle="modal" data-target="#popup_bid" class="fw-7 font-2">Đăng nhập</a>
                                @else
                                                Chào, {{Auth::user()->name}}
                                                @endif
                            </div>
                            ...
                            <div class="mobi-icon-box">
                                ...
                                <div class="box flex">
                                    ...
                                    <div class="content fs-13">
                                        Hotline: <h5>{{$shared_config['hotline']['value']}}</h5>
                                    </div>
                                </div>
                                <div class="box flex">
                                    <div class="icon">
                                    ...
                                    <div class="content fs-13 lh-16">
                                        Email: <h5>{{ $shared_config['email']['value']}}</h5>
                                    </div>
                                </div>
                            </div>
                        </div>
