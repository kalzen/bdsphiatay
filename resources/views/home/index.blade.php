                    ...
                    <div class="container">
                        <div class="row">                      
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="{{asset('phiatay/assets/images/img-box/meet-1.jpg')}}" alt="images"></a>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="{{asset('phiatay/assets/images/img-box/meet-2.jpg')}}" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="box hover-img">
                                    <div class="images relative img-style">
                                        <a href="agents-detail.html"><img src="{{asset('phiatay/assets/images/img-box/meet-3.jpg')}}" alt="images"></a>
                                        <div class="icon-socials">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-twitter"></i></a>
                                            <a href="#"><i class="fab fa-linkedin-in"></i></a>
                            ...
                            <div class="col-lg-12">
                                <div class="box-text flex justify-center">
                                    <p>Become an agent and get the commission you deserve. </p> <a href="#" class="text-color-3 font-2 fw-7"> Contact us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!--<section class="tf-section flat-testimonial section-mb" >
                    <div class="container">
                        <div class="row">                      
                            <div class="col-lg-12">
                                <div class="heading-section center">
                                    <h2>Khách hàng phản hồi về chúng tôi</h2>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="box center">
                                                ...
                                                <div class="author-box">
                                                    <div class="images">
                                                        <img src="{{asset('phiatay/assets/images/author/author-testimonial.jpg')}}" alt="images">
                                                    </div>
                                                    <h4>Esther Howard</h4>
                                ...
                                <div class="box-title flex justify-center">
                                    <div class="inner-title flex justify-center align-center"><h4 class="title-1 fw-4">Become our next customer, and find your dream home </h4> <a href="tel:{{$shared_config['hotline']['value']}}" ><h4 class="text-color-3">Hotline: {{$shared_config['hotline']['value']}}</h4> </a></div> 
                                </div>
                            </div>
                        </div>
                    </div>
