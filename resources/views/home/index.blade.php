...
<!-- slider -->
 <!-- slider -->
 <section class="slider home2 home3">
                    <div class="slider-item">
                        <div class="img-slider">
                            <img class="img-item" src="{{asset('phiatay/assets/images/slider/bg-slider-3.jpg')}}" alt="">
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="content po-content-two">
                                        <div class="heading center">
                                            <h1 class="text-color-1 fs-60 font-2 fw-8 wow fadeInDown js-letters"  data-wow-delay="50ms" data-wow-duration="1000ms" >Tìm bất động sản ưng ý</h1>
                                            <p class="font-2  text-color-1 text-t">Tìm kiếm bất động sản ưng ý theo mong muốn của bạn</p>
                                        </div>
                                            ...
                                            <div class="box-tab center">
                                                <ul class="menu-tab tab-title flex justify-center">
                                                    <li class="item-title active">
                                                        <h4 class="inner">Nhà đất bán</h4>
                                                    </li>
                                                    <li class="item-title style">
                                                        <h4 class="inner"> Nhà đất cho thuê </h4>
                                                    </li>
                                                </ul>
                                            </div>
