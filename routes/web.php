...
Route::get('/du-an/tim-kiem', [App\Http\Controllers\ProductController::class, 'searchPage'])->name('product.search.page');
...
Route::get('/du-an', [App\Http\Controllers\ProductController::class, 'index'])->name('product.index');
